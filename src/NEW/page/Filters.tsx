...
const  Filters  = (props:any) =>{
    ...
    const blinds = ["🎓  Освіта/Педагогіка (01) ","🎭  Культура і мистецтво (02)","📘  Гуманітарні науки (03)","⛪  Богослов’я (04)","🤝  Соціальні та поведінкові науки (05)","📰  Журналістика (06)","🏢  Управління та адміністрування (07)","⚖️  Право (08)","🧬  Біологія (09)","🏞️  Природничі науки (10)","➗  Математика та статистика (11)","💻  Інформаційні технології (12)","🎓  Освіта/Педагогіка (13) ","🎭  Культура і мистецтво (14)","📘  Гуманітарні науки (15)","⛪  Богослов’я (16)","🤝  Соціальні та поведінкові науки (17)","📰  Журналістика (18)","🏢  Управління та адміністрування (19)","⚖️  Право (20)","🧬  Біологія (21)","🏞️  Природничі науки (22)","➗  Математика та статистика (23)","💻  Інформаційні технології (24)","🎓  Освіта/Педагогіка (25) ","🎭  Культура і мистецтво (26)","📘  Гуманітарні науки (27)","⛪  Богослов’я (28)","🤝  Соціальні та поведінкові науки (29)"];
    ...
    return(
        <div className={styles.wrapS}>
           ...
           <FiltersBlock>
             ...
             {blinds.slice(0,12).map((item)=> <BlindsFilter  title={item}/>)}
            <div>{flag ? blinds.slice(12,29).map((item)=> <BlindsFilter  title={item}/>):<h3 onClick={open} className={styles.viewMore }>Показати ще 17</h3>}</div>
           </FiltersBlock>
